...
check_descriptions <- tribble(
  ...
  "uses_testing", "Uses testing package", "", "Testing & CI",
...
authors |> 
  ...
  mutate(
    ...
    package = forcats::fct_reorder(package, downloads)
  ) |> 
  ggplot(aes(package, name, fill = role)) +
    geom_tile() +
    theme(
